...
function AppContent() {
  ...
  const isNoNavPage = location.pathname === "/" ||
          ...
          <div className={`navbar-menu ${menuOpen ? 'open' : ''}`}>
            <div className="navbar-menu-top">
              ...
              <ul className="navbar-menu-toplist">
                <li onClick={() => { navigate('/main'); toggleMenu(); }}>
                  <FaHashtag size={30} color='#746745' />
                  <h4>메인 화면</h4>
                </li>
                <li onClick={() => { navigate('/mypage'); toggleMenu(); }}>
                  <CgProfile size={30} color='#746745' />
                  <h4>마이페이지</h4>
                </li>
                <li onClick={() => { navigate('/mypage/feedback'); toggleMenu(); }}>
                  <TbMessage2Exclamation size={30} color='#746745' />
                  <h4>나의 피드백</h4>
                </li>
                <li onClick={() => { navigate('/mypage/pattern'); toggleMenu(); }}>

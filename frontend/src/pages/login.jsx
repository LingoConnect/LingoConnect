      ...
      <div className="login-login">
        ...
        <div className="login-submit">
          ...
          <div className="login-submit-icon">
            ...
            >
              <img src={process.env.PUBLIC_URL + '/img/google.png'} alt="구글 로그인" />
            </button>
            <button
              onClick={() => {
                window.open('https://chat.com');
              }}
            >
              <img src={process.env.PUBLIC_URL + '/img/chat.png'} alt="카카오톡 로그인" />
            </button>
            <button
              onClick={() => {
            ...
            >
              <img src={process.env.PUBLIC_URL + '/img/twitter.png'} alt="트위터 로그인" />
            </button>
          </div>
        </div>
      </div>
